 ...
 */
registerUserR = function(groupid, userid, registerInformation, socket) {
 ...
 * @param userid
 */
deregisterUserR=function (groupid, userid) {
 ...
 * @param userId
 */
trimSessionStateForUserid=function (callId, groupid, userId) {
 ...
 * @param userid
 */
getUserInformation=function (groupid, userid) {
 ...
 * @param data
 */
updateUserInformation=function (groupid, userid, data) {
 ...
 * @param socketid
 */
getGroupidFromSocketid = function (socketid) {
	if (signallingSockets[socketid]) {
 ...
 */
geGroupidAndUsertUseridFromSocketid = function (socketid) {
 ...
 * @param userid
 */
getSignallingSocket = function (groupid, userid) {
	var reg = registeredUsersSignallingSockets[groupid];
	if (reg) {
		return reg[userid];
	}
 ...
 */
sendUsersInformationUpdates = function (groupid) {
	var reg = groups[groupid];
	if (reg) {
 ...
 * @param state
 */
addSessionState = function (callId, groupid, transactionId, callParticipants, state) {
	var session_state = {
			callId: callId,
			groupid: groupid,
 ...
 * @param callId
 */
addCurrentCallToUserInformation =function (groupid, userId, callId) {
 ...
 * @param callId
 */
removeSessionState = function (callId) {
 ...
 * @param callId
 */
removeCurrentCallFromUserInformation = function (groupid, userId, callId) {
	var user_information = getUserInformation(groupid, userId);
	if (user_information) {
 ...
 * @returns
 */
getSessionState = function (callId) {
 ...
 * @param data
 */
updateSessionState = function (callId, data) {
 ...
 * @param callId
 */
removeUserFromCall = function (groupid, userid, callId) {
 ...
 *        }
 */
getRegisteredUsers = function (groupid) {
	var reg = groups[groupid];
	if (!reg) {
		return {};
	}
 ...
 *                }
 */
getSessionStatesForUserid = function (groupid, userid) {
	var res = {};
...
*/
getCallScreenSessionsId = function (groupid, userid){
	var res = {};
	var position = 0;
	for (var call_id in sessionStates) {
		var session_state = sessionStates[call_id];
